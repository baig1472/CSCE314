...
/*
 * Taken from link https://github.com/smanikar/primality-testing/blob/master/proposal/src/AKS.java
 * */
public class AKA_TEST
{
    ...
    static long mPower(long x, long y, long n)
    {
        long m, p, z;
        m = y;
        p = 1;
    ...
    static boolean findPower(BigInteger n, int l)
    {
        int i;
        for(i = 2; i < l; i++)
        {
    ...
    static BigInteger mPower(BigInteger x, BigInteger y, BigInteger n)
    {
