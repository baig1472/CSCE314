...
public class Config {
  ...
  public final static String APPLICATIONNAME = "FinalProduct";
  public final static String def_PrimesFile = "primes.txt";
  public final static String def_CrossesFile = "crosses.txt";
}